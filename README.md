...
- **Node.js & npm:** Make sure you have a recent version of Node.js installed on your machine. Download from the [official website](https://nodejs.org/).
...
### Run the tests
- Install all project specific packages with: `npm install`
